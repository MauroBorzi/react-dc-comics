  ...
  return (
    <footer>
      <div className="blue-banner">
        <div className="container">
          <div className="row">
            ...
            <div className="col-20 m-custom">
              <img className="fontImg" src="./img/buy-comics-shop-locator.png" alt="" />
      ...
      <div className="bottom-footer">
        <div className="container">
          <div className="row space-between p-30">
